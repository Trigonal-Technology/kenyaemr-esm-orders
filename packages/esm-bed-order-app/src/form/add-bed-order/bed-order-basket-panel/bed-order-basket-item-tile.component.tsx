...
import styles from './bed-order-basket-item-tile.scss';
import { type BedOrderBasketItem } from '../../../types';

export interface OrderBasketItemTileProps {
  orderBasketItem: BedOrderBasketItem;
  onItemClick: () => void;
  onRemoveClick: () => void;
}

export function BedOrderBasketItemTile({
  orderBasketItem,
  onItemClick,
  onRemoveClick,
...
function OrderActionLabel({ orderBasketItem }: { orderBasketItem: BedOrderBasketItem }) {
  const { t } = useTranslation();
